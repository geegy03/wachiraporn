                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(221, 61, 230, 173), // กำหนดสีพื้นหลัง
                      ),
                      child: Text(
                        'บันทึกสินค้า',
                        style: TextStyle(
                          color: Color.fromARGB(221, 255, 255, 255), // กำหนดสีของฟอนต์
                          fontSize: 20,
                          fontWeight: FontWeight.w400,
                        ),
                      ),
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(221, 150, 8, 8), // กำหนดสีพื้นหลัง
                      ),
                      child: Text(
                        'เคลียร์สินค้า',
                        style: TextStyle(
